    ...
    <div className="container py-6 md:py-10 max-w-7xl mx-auto">
      <div className="grid md:grid-cols-2 gap-8">
        <div className="space-y-4">
          <div className="relative aspect-square overflow-hidden rounded-lg border">
            <img src={printable?.image || "/placeholder.svg"} alt={printable?.title} className="object-contain" />
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-2">
            ...
            {printable?.originalPrice && (
              <Badge variant="outline" className="text-green-600">
                {Math.round(((printable.originalPrice - printable.price) / printable.originalPrice) * 100)}% OFF
              </Badge>
            )}
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium">{new Date(printable?.dateAdded ?? '').toLocaleDateString()}</span>
            </div>
            <div className="flex justify-between text-sm">
      ...
      <Tabs defaultValue="details" className="mt-10">
        ...
        <TabsContent value="reviews" className="mt-6 space-y-6">
          <div className="flex items-center gap-4">
            <div className="text-center">
              ...
              <div className="text-sm text-muted-foreground mt-1">Based on {printable?.reviews} reviews</div>
            </div>
              ...
              {[5, 4, 3, 2, 1].map((star) => {
                ...
                return (
                  <div key={star} className="flex items-center gap-2">
                    ...
                    <div className="w-12 text-sm text-right text-muted-foreground">{percentage}%</div>
                  </div>
                )
              })}
            </div>
        ...
        <TabsContent value="license" className="mt-6 space-y-4">
          ...
          <div className="space-y-4">
            <p>
              This printable is licensed for personal use only. When you purchase this item, you are granted a
              non-exclusive, non-transferable license to use the digital files for your own personal, non-commercial
              purposes.
            </p>
