    ...
    <Card className="overflow-hidden group">
      ...
      <CardContent className="p-4">
        <div className="flex justify-between items-start gap-2">
          ...
          <Button variant="ghost" size="icon" className="h-8 w-8 shrink-0" onClick={() => setIsFavorite(!isFavorite)}>
          ...
          <div className="flex">
            {Array(5)
              ...
              .map((_, i) => (
                <svg
                  key={i}
                  className={cn("h-4 w-4", i < printable.rating ? "text-yellow-400 fill-yellow-400" : "text-gray-300")}
